 ...
 * @author Jan Suwart
 * 
 * @edited by Kathy Kennedy to increase max interval for longer appointments
*/
(function (root, factory) {
	...
	function initialize(_this, el, options) {
		...
		if (_this.el.length !== undefined) {
			...
			return;
		} else if (_this.options.interval > 240) {
			console.warn('appointment-picker: the maximal interval is 240');
			return;
		}
